...
public class UserServiceImpl implements IUserService {
	...
	@Autowired
	public void setEmaiSendingService(EmailSending emaiSendingService) {
		this.emaiSendingService = emaiSendingService;
	}

	@Autowired
	public void setPasswordEncrypt(PasswordEncryption passwordEncrypt) {
		this.passwordEncrypt = passwordEncrypt;
	}

	@Autowired
	public void setUserRegister(UserRegistratrationImpl userRegister) {
